package com.nepxion.swing.layout.filed;
...
/**
 * FiledLayout lays out components singled filed.  This layout manager is
	...
	implements LayoutManager, Serializable
{
	...
	/**
	 * Constructs an instance of FiledLayout that will align components in a
	...
	/**
	 * Constructs an instance of FiledLayout using the default gap and LEFT
	...
	public FiledLayout (int orientation)
	{
	...
	/**
	 * Constructs an instance of FiledLayout.
	 *
	 * @param orientation      ROW or COLUMN -- should the components be aligned in
	 *                         a row or column
	...
	public FiledLayout (int orientation, int justification, int gap)
	{
	    // Validate parameters
	    if (orientation != ROW)
	        orientation = COLUMN;
