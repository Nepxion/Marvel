...
*/
	...
	protected void init (double [] col, double [] row)
	{
	    // Check parameters
	    if (col == null)
	        throw new IllegalArgumentException("Parameter col can't be null");
	    
	    if (row == null)
	        throw new IllegalArgumentException("Parameter row can't be null");
	 ...
	 *
	 * @param component     desired component.  This parameter can't be null.
	 * @param constraint    new set of constraints.  This parameter can't be null.
	 */
	    ...
	    (Component component, TableLayoutConstraints constraint)
	{
	    ...
	    if (component == null)
	        throw new IllegalArgumentException
	            ("Parameter component can't be null.");
	    else if (constraint == null)
	        throw new IllegalArgumentException
	            ("Parameter constraint can't be null.");
	 ...
	 * container is resized.
	 *
	 * @param row    heights of each of the rows.  This parameter can't be null.
	 *
	 * @see #getRow
	 */
	 ...
	 * @param size    width of the column.  This parameter can't be null.
	 *
	 * @see #getColumn
	 */
	 ...
	 *                valid, an ArrayOutOfBoundsException will be thrown.
	 * @param size    height of the row.  This parameter can't be null.
	 *
	 * @see #getRow
	 */
	 ...
	 * preferred size.  This method can't guarantee that all components will be
	 ...
	 * wide while component B wants to be 100 pixels wide, they can't both be
	 ...
	 * size, will ensure that all components are at least as large as their
	 * minimum size.  This method can't guarantee that all components will be
	...
	public void addLayoutComponent (Component component, Object constraint)
	{
	    ...
	    else if (constraint instanceof TableLayoutConstraints)
	    {
	        ...
	        throw new IllegalArgumentException
	        ("can't accept a constraint of class " + constraint.getClass());
	}
