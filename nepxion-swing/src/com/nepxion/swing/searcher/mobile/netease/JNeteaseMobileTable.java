...
public class JNeteaseMobileTable
	extends JBasicTable
{
	/**
	 ...
	 */	
	public JNeteaseMobileTable()
	{
		super(new NeteaseMobileTableModel(new ArrayList()));
		...
		JBasicMenuItem clearMenuItem = new JBasicMenuItem(NeteaseMobileController.getClearAction(this));
