	...
	extends JPanel
{
		...
		extends JPanel
	{
		...
		public ToolBar()
		{
			...
			JBasicButton searchButton = new JBasicButton(SinaIPController.getSearchAction(JSinaIPPanel.this));
			JBasicButton clearButton = new JBasicButton(SinaIPController.getClearAction(table));
	...
	/**
	 * Gets the ip table.
	 * @return the instance of JSinaIPTable
	 */
	public JSinaIPTable getIPTable()
	{
		return table;
	}
