	...
	extends JPanel
{
	...
	/**
	 * The netease ip table.
	 */
	private JNeteaseIPTable table;
	
	/**
	 * Constructs with the default.
	 */
	public JNeteaseIPPanel()
	{
		table = new JNeteaseIPTable();
		...
		extends JPanel
	{
		...
		public ToolBar()
		{
			...
			JBasicButton searchButton = new JBasicButton(NeteaseIPController.getSearchAction(JNeteaseIPPanel.this));
			JBasicButton clearButton = new JBasicButton(NeteaseIPController.getClearAction(table));
	...
	/**
	 * Gets the ip table.
	 * @return the instance of JNeteaseIPTable
	 */
	public JNeteaseIPTable getIPTable()
	{
		return table;
	}
