package com.nepxion.demo.test.dialog;
...
public class TranslucentDialogDemo
	extends JDialog
{
	/**
 * 
 */
	...
	public TranslucentDialogDemo(boolean doNotAutoClose, JFrame parentJFrame, String message)
	{
		...
		{
			this.setLocation(parentJFrame.getLocationOnScreen().x + (parentJFrame.getSize().width / 2) - size.width / 2, parentJFrame.getLocationOnScreen().y + (parentJFrame.getSize().height / 2) - size.height / 2);
		}
		else
		{
		...
		if (message.length() > 10)
		{
			...
			messageLabel1.setBounds(size.width / 2 - messageLabel1.getPreferredSize().width / 2, size.height / 2 - messageLabel1.getPreferredSize().height / 2 - 25, messageLabel1.getPreferredSize().width, messageLabel1.getPreferredSize().height);
			...
			messageLabel2.setBounds(size.width / 2 - messageLabel2.getPreferredSize().width / 2, size.height / 2 - messageLabel2.getPreferredSize().height / 2 + 4, messageLabel2.getPreferredSize().width, messageLabel2.getPreferredSize().height);
		...
		else
		{
			...
			messageLabel.setBounds(size.width / 2 - messageLabel.getPreferredSize().width / 2, size.height / 2 - messageLabel.getPreferredSize().height / 2 - 12, messageLabel.getPreferredSize().width, messageLabel.getPreferredSize().height);
	...
	public TranslucentDialogDemo(JFrame parentJFrame, String message)
	{
		super(parentJFrame);
		this.setUndecorated(true);
		setSize(size);
		...
		messageLabel.setForeground(Color.black);
		messageLabel.setFont(new Font("楷体", Font.BOLD, 18));
		messageLabel.setBounds(size.width / 2 - messageLabel.getPreferredSize().width / 2, size.height / 2 - messageLabel.getPreferredSize().height / 2 - 6, messageLabel.getPreferredSize().width, messageLabel.getPreferredSize().height);
	...
	private class UndergroundPanel
		extends JPanel
	{
		...
		protected void paintComponent(Graphics g)
		{
			...
			GradientPaint gradient = new GradientPaint(0.0f, 0.0f, new Color(230, 230, 230, 230), 0.0f, (float) height, new Color(230, 230, 230, 230));
	...
	private class MouseInputAdaptert
		extends MouseInputAdapter
	{
		...
		public void mouseDragged(MouseEvent e)
		{
			...
			TranslucentDialogDemo.this.setLocation(TranslucentDialogDemo.this.getLocationOnScreen().x + tempScreen.x - oldCursorPosition.x, TranslucentDialogDemo.this.getLocationOnScreen().y + tempScreen.y - oldCursorPosition.y);
	...
	{
		TranslucentDialogDemo test = new TranslucentDialogDemo(TranslucentDialogDemo.noAutoClose, null, "ddddddddd");
		TranslucentDialogDemo test2 = new TranslucentDialogDemo(null, "ddddddddd");
